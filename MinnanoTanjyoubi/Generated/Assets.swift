...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let scheme8FoundationPrimary = ColorAsset(name: "scheme_8_foundation_primary")
    internal static let scheme8FoundationSub = ColorAsset(name: "scheme_8_foundation_sub")
    internal static let scheme8Text = ColorAsset(name: "scheme_8_text")
    internal static let scheme8Thema1 = ColorAsset(name: "scheme_8_thema1")
    internal static let scheme8Thema2 = ColorAsset(name: "scheme_8_thema2")
    internal static let scheme8Thema3 = ColorAsset(name: "scheme_8_thema3")
    internal static let scheme8Thema4 = ColorAsset(name: "scheme_8_thema4")
  }
  internal enum Images {
    internal static let appiconRemove = ImageAsset(name: "Appicon-remove")
    internal static let appLogo = ImageAsset(name: "app_logo")
    internal static let appMinnanoOiwai = ImageAsset(name: "app_minnano_oiwai")
  }
}
