...
internal enum Asset {
  internal enum Colors {
    internal static let foundationColorDark = ColorAsset(name: "FoundationColorDark")
    internal static let foundationColorLight = ColorAsset(name: "FoundationColorLight")
    internal static let themaColor1 = ColorAsset(name: "ThemaColor1")
    internal static let themaColor2 = ColorAsset(name: "ThemaColor2")
    internal static let themaColor3 = ColorAsset(name: "ThemaColor3")
    internal static let themaColor4 = ColorAsset(name: "ThemaColor4")
